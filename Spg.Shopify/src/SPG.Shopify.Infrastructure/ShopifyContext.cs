...
using Address = Spg_Shopify.Domain.Model.Address;

namespace Spg.Shopify.Infrastructure
{
    // 1. diese Klasse muss aus DBContext ableiten
    public class ShopifyContext : DbContext
    {
        ...
        public ShopifyContext(DbContextOptions options)
            : base(options)
        { }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Item>().HasKey(p => p.Name); // OK
            modelBuilder.Entity<Item>().Property(p => p.Name).IsRequired(); // OK
        ...
        public void Seed()
        {
            ...
            List<Customer> customers = new Faker<Customer>("de").CustomInstantiator(f =>
                ...
                .Rules((f, c) =>
                {
                    ...
                    c.Address = new Spg_Shopify.Domain.Model.Address(
            ...
            List<Item> products = new Faker<Item>("de").CustomInstantiator(f =>
                new Item(
